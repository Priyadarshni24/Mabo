...
import com.cometchat.pro.uikit.ui_components.messages.location.LocationTrack;
...
*/
 ...
 public void onMoveLive()
 {
     ...
     if(minutes>=0&&minutes<=duration)
     {
         ...
         Picasso.get().load(getIntent().getStringExtra(AVATAR)).resize(100,100).transform(new CircleTransform()).into(new Target() {
             @Override
