...
import com.advengers.mabo.Cometchat.Adapter.ContactListAdapter;
import com.advengers.mabo.Cometchat.Contracts.ContactsContract;
...
import com.advengers.mabo.Cometchat.Presenters.ContactsListPresenter;
...
public class ContactsFragment extends Fragment implements ContactsContract.ContactView{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        new Thread(() -> contactPresenter.fetchUsers(getContext())).start();
             ...
             contactRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                 ...
                 public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                     ...
                     if (!recyclerView.canScrollVertically(1)) {
                         contactPresenter.fetchUsers(getContext());
                     }
