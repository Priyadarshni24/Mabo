...
public class CallScreenButton extends LinearLayout implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (diff < 0) {
                    diffThreshold = CommonUtils.dpToPx(getContext(), ANSWER_THRESHOLD);
                    ...
                    diffThreshold = CommonUtils.dpToPx(getContext(), DECLINE_THRESHOLD);
    ...
    private void intiComponentView() {
        ...
        inflate(getContext(), R.layout.answer_n_decline_button, this);

        this.ivGreenArrowOne = findViewById(R.id.green_arrow_one);
        this.ivGreenArrowTwo = findViewById(R.id.green_arrow_two);
        this.ivGreenArrowThree = findViewById(R.id.green_arrow_three);
        this.ivRedArrowOne = findViewById(R.id.red_arrow_one);
        this.ivRedArrowTwo = findViewById(R.id.red_arrow_two);
        this.ivRedArrowThree = findViewById(R.id.red_arrow_three);
        this.fab = findViewById(R.id.fab);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            fab.getBackground().setTint(Color.WHITE);
        }

        this.fab.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.primaryLightColor)));
    ...
    private ObjectAnimator getUpAnimation(View target) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(target, "translationY", 0, -1 * CommonUtils.dpToPx(getContext(), 16));
