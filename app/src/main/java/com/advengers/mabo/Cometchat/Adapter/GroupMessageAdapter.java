...
import com.advengers.mabo.Cometchat.Activity.VideoViewActivity;
import com.advengers.mabo.Cometchat.AsyncTask.DownloadFile;
...
import com.advengers.mabo.Cometchat.CustomView.StickyHeaderAdapter;
...
import com.advengers.mabo.Cometchat.ViewHolders.LeftAudioViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.LeftFileViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.LeftImageVideoViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.LeftMessageViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.LeftReplyViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.RightAudioViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.RightFileViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.RightImageVideoViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.RightMessageViewHolder;
import com.advengers.mabo.Cometchat.ViewHolders.RightReplyViewHolder;
...
import static com.advengers.mabo.Cometchat.Utils.FileUtils.getFileExtension;
import static com.advengers.mabo.Cometchat.Utils.FileUtils.getFileName;
...
//                                                player.prepare();
    ...
    private void setReadIcon(CircleImageView circleImageView, BaseMessage baseMessage){
        if (baseMessage.getReadAt()!=0){
            ...
            circleImageView.setCircleBackgroundColor(context.getResources().getColor(R.color.secondaryColor));
            circleImageView.setImageResource(R.drawable.ic_check_white_24dp);
        }
    }
